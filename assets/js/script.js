...
// Dirubah 
const pengirim = "Axel Carvallo";
const nomorWa = "6281248815791" // awalan nomor 0 harus di awalin 62
const textWa = "Makasih yah sudah membuat hidupku menjadi lebih berwarna...."
const pesan = `Hai, Vanes maaf yah Aku tidak bisa menjadi yang seperti yang kamu inginkan.
Aku cuman mau bilang semoga kamu lebih bahagia disana dengan orang pilihan mu, dan terima kasih sudah 
membuat hari-hari Ku lebih berwarna dari sebelumnya, walaupun itu cuman sesaat, tapi itu adalah moment yang tidak bisa dilupakan.
One More Terima Kasih Vanes.....💖💖💖🥰🥰🥰`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Haiii.... sebelum masuk tulis nama mu dulu dong...😁',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Masukin Nama Kamu Dong CANTIK😊 :(`)
      }
      return { login }
    }
  }).then((result) => {
